...
This repository is a living document. It has no standards release process, version matrix, or registry of adopting repositories.


## How to use it

1. Read the standards that apply to the CLI.
2. Copy useful checklists or patterns into the repository when local ownership makes maintenance clearer.
3. Reference the applicable standard ID from copied material or implementation work.
...
If the standard itself is wrong, change this repository. If one CLI is wrong, change that CLI.
