...
an interactive terminal when practical.
...
Document required programs. Install them in CI and fail required end-to-end
verification when they are absent.

Cmdk treats tmux as a documented external prerequisite and must exercise it in
end-to-end CI.
