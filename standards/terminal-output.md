...
useful. Require an explicit value; bare `--color` is not a fleet contract.
...
Commands may define a narrower contract when needed. Keep redirected output
clean by default and mark intentional drift with this standard ID and a reason.
